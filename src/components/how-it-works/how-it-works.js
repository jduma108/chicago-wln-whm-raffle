    ...
    <div className={styles.howItWorksWrapper}>
        ...
        <div className={styles.moreInfoWrapper}>
            ...
            <ul>
                ...
                <li>After filling out the raffle form, please Venmo Sophie Lancaster <span className={styles.bold}>@Sophie-Lancaster</span> and include the following message: <span className={styles.bold}>Chicago WLN Raffle Event 2025 - [insert your name].</span></li>
        ...
        <h2 className={styles.raffleDates}>RAFFLE EVENT OPEN FROM MARCH 24 - MARCH 28</h2>
    </div>
);
